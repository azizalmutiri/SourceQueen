...
send_key(msg.sender_user_id_,'  [SourceQueen](t.me/@SourceQueen)',nil,inline,msg.id_)
return false
end
...
return [[
Dev : [Aziz](https://t.me/ziz_6) .
Cha : [𝐒𝐎𝐔𝐑𝐂𝐄 𝐐𝐔𝐄𝐄𝐍](https://t.me/SourceQueen) .
]]
end
...
"‏- أكثر مهمة منزلية تقوم بها؟",
  "‏- آخر أغنية استمعت إليها؟",
  "‏- ماذا تكتب على جبين الحياة؟",
  "‏- أين أنت الآن أيها الجميل؟",
}
local ghg = {
"لبيه ي وتينها",
"عيون ["..Bot_Name.."] .",
...
local ddd = {
"عِيناك أضاعت النّاظرين عِيناك خمر مُباح",
"عيناك حب وحديثك حياة.",
"عيّناكِ بلائي وأبتلائي ، وأنا المُغرم المبّتلي🖤",
"‏عَينْاكَ قَلبِي و قَلبِي لِـ غَيرِ عَينَاكَ لا يَنْحَني .",
"‏عيونك وطن مالي عن سماها رحيل. .",
"‏عيونك سما تَضويها ألف نجمه🖤.",
"‏عيناكِ داري ودارُ السلام وأنتِ البدايةُ ومسكُ الختام💛 .",
}
local Text = msg.text
...
elseif not msg.SudoUser and Text==" عيونك" or Text == "عيونك" then
return 
sendMsg(msg.chat_id_,msg.id_,ddd[math.random(#ddd)])
elseif not msg.SudoUser and Text==" هاي" or Text == "هاي" then
sendMsg(msg.chat_id_,msg.id_,sss[math.random(#sss)])
elseif not msg.SudoUser and Text==" كت تويت" or Text == "كت تويت" then
sendMsg(msg.chat_id_,msg.id_,Queen[math.random(#Queen)])
...
‏
  ...
  --=====================================
  elseif Text== "عزي" or Text== "عزيز" or Text=="عزيي" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[Aziz.](https://t.me/ziz_6)")
end 
end 
